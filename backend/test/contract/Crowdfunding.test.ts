...
// and hardhat-ethers' NetworkConnection type extension (connection.ethers).
import "@nomicfoundation/hardhat-ethers-chai-matchers";
import { Crowdfunding } from "../../typechain-types/index.js";
...
describe("Crowdfunding", function () {
  ...
  beforeEach(async () => {
    ...
    crowdfunding = (await Factory.deploy()) as unknown as Crowdfunding;
  ...
  describe("Fund release", () => {
    ...
    it("releases only the milestone's allocated amount, not the full balance", async () => {
      ...
      // Cast: TS infers `bigint * bigint` as number here due to the
      // intersection-typed ethers helpers; at runtime these are bigints.
      const gasUsed = (receipt!.gasUsed * receipt!.gasPrice!) as unknown as bigint;
