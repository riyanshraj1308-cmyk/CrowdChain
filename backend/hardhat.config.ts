...
// hardhat-ignition, hardhat-verify, and hardhat-gas-reporter — none of which
// this project uses — so importing only what's actually used keeps the
// dependency tree (and `npm audit`) lean.
...
export default defineConfig({
  plugins: [hardhatEthers, chaiMatchers, networkHelpers, typechain, mocha],
  solidity: {
    version: "0.8.24",
    settings: {
      optimizer: {
